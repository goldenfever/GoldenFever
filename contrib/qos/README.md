...
This means one can have an always-on gfrd instance running, and another local gfrd/gfr-qt instance which connects to this node and receives blocks from it.
