...
RESOURCES += src/qt/gfr.qrc src/qt/gfr_locale.qrc

TRANSLATIONS += src/qt/locale/gfr_bg.ts \
                src/qt/locale/gfr_de.ts \
                src/qt/locale/gfr_en.ts \
                src/qt/locale/gfr_es.ts \
                src/qt/locale/gfr_fi.ts \
                src/qt/locale/gfr_fr.ts \
                src/qt/locale/gfr_it.ts \
                src/qt/locale/gfr_ja.ts \
                src/qt/locale/gfr_pl.ts \
                src/qt/locale/gfr_pt.ts \
                src/qt/locale/gfr_ru.ts \
                src/qt/locale/gfr_sk.ts \
                src/qt/locale/gfr_sv.ts \
                src/qt/locale/gfr_vi.ts \
                src/qt/locale/gfr_zh_CN.ts \
                src/qt/locale/gfr_zh_TW.ts
