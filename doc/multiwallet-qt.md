...
In order to support loading of multiple wallets in gfr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gfr.cpp.
...
Changes to gfr.cpp
----------------------
gfr.cpp is the entry point into gfr-qt, and as such, will require some minor modifications to provide hooks for
