...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gfr features */
        {"gfr", "masternode", &masternode, true, true, false},
        {"gfr", "listmasternodes", &listmasternodes, true, true, false},
        {"gfr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gfr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gfr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gfr", "masternodedebug", &masternodedebug, true, true, false},
        {"gfr", "startmasternode", &startmasternode, true, true, false},
        {"gfr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gfr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gfr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gfr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gfr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gfr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gfr", "mnbudget", &mnbudget, true, true, false},
        {"gfr", "preparebudget", &preparebudget, true, true, false},
        {"gfr", "submitbudget", &submitbudget, true, true, false},
        {"gfr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gfr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gfr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gfr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gfr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gfr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gfr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gfr", "checkbudgets", &checkbudgets, true, true, false},
        {"gfr", "mnsync", &mnsync, true, true, false},
        {"gfr", "spork", &spork, true, true, false},
        {"gfr", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gfr", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gfrd, or the -server option to gfr-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gfr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11765/\n";
}
