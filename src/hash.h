...
inline int GetHashSelection(const uint256 PrevBlockHash, int index) {
    ...
    #define STGFR_OF_LAST_16_NIBBLES_OF_HASH 48
    int hashSelection = PrevBlockHash.GetNibble(STGFR_OF_LAST_16_NIBBLES_OF_HASH + index);
    return(hashSelection);
}

template<typename T1>
inline uint256 HashZ16R(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
//	static std::chrono::duration<double>[16];
    ...
    for (int i=0;i<8;i++)
    {
        ...
        //LogPrintf("Hash selector: index=%d\n", hashSelection);
        ...
        switch(hashSelection) {
            case 0:
                ...
                sph_shavite512 (&ctx_shavite, static_cast<void*>(&hash[i]), lenToHash);
            ...
            case 1:
                ...
                sph_simd512 (&ctx_simd, static_cast<void*>(&hash[i]), lenToHash);
            ...
            case 2:
                ...
                sph_echo512 (&ctx_echo, static_cast<void*>(&hash[i]), lenToHash);
            ...
            case 3:
                ...
                sph_hamsi512 (&ctx_hamsi, static_cast<void*>(&hash[i]), lenToHash);
            ...
            case 4:
                ...
                sph_fugue512 (&ctx_fugue, static_cast<void*>(&hash[i]), lenToHash);
            ...
            case 5:
                ...
                sph_shabal512 (&ctx_shabal, static_cast<void*>(&hash[i]), lenToHash);
            ...
            case 6:
                ...
                sph_whirlpool (&ctx_whirlpool, static_cast<void*>(&hash[i]), lenToHash);
            ...
            case 7:
                ...
                sph_sha512(&ctx_sha512, static_cast<void*>(&hash[i]), lenToHash);
