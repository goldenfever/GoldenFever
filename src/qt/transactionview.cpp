                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Gfr from zGfr"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGfr"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGfr));
...
void TransactionView::setModel(WalletModel* model)
{
    ...
    if (model) {
        ...
        transactionView->setAlternatingRowColors(false); //we dont't need it with transparent background
