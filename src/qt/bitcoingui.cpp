                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GFR Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    labelEncryptionIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0); border: 0px;}");
    labelEncryptionIcon->setMaximumSize(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE);
    labelConnectionsIcon = new QPushButton();
    labelConnectionsIcon->setFlat(true); // Make the button look like a label, but clickable
    labelConnectionsIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0); border: 0px;}");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gfr address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gfr: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGFR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GFR Core"), this);
    aboutAction->setStatusTip(tr("Show information about GFR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gfr"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gfr addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gfr addresses"));
    ...
    openAction->setStatusTip(tr("Open a Gfr: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GFR Core help message to get a list with possible Gfr command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GFR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gfr network", "", count));
}
...
{
    QString strTitle = tr("GFR Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        encryptWalletAction->setVisible(false); // TODO: decrypt currently not supported and menu item is disabled
        break;
